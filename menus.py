...
class MenuSprites():
    def __init__(self):
        ...
        #Rx Channels
        self.ch0_status = pygame.Rect(c.col_two, c.row_one, 20, 20)
        self.ch1_status = pygame.Rect(c.col_two, c.row_one + 30, 20, 20)
        self.ch2_status = pygame.Rect(c.col_two, c.row_one + 60, 20, 20)
        self.ch3_status = pygame.Rect(c.col_two, c.row_one + 90, 20, 20)
        self.ch4_status = pygame.Rect(c.col_two, c.row_one + 120, 20, 20)
        self.ch5_status = pygame.Rect(c.col_two, c.row_one + 150, 20, 20)
        self.ch6_status = pygame.Rect(c.col_two, c.row_one + 180, 20, 20)
        self.ch7_status = pygame.Rect(c.col_two, c.row_one + 210, 20, 20)
        ...
        for event in events:              
            ...
            if event.type == pygame.MOUSEBUTTONUP:
                if self.reset_button.collidepoint(event.pos):
                    ...
                    self.check = True
                elif self.test_button.collidepoint(event.pos):
                    self.mode = "test"
    ...
    def testElements(self, screen, chip, ready, rxStatus):
        super().__init__() 
        ...
        pygame.draw.rect(screen, c.GREEN if rxStatus[0] else c.RED, self.ch0_status)
        pygame.draw.rect(screen, c.GREEN if rxStatus[1] else c.RED, self.ch1_status)
        pygame.draw.rect(screen, c.GREEN if rxStatus[2] else c.RED, self.ch2_status)
        pygame.draw.rect(screen, c.GREEN if rxStatus[3] else c.RED, self.ch3_status)
        pygame.draw.rect(screen, c.GREEN if rxStatus[4] else c.RED, self.ch4_status)
        pygame.draw.rect(screen, c.GREEN if rxStatus[5] else c.RED, self.ch5_status)
        pygame.draw.rect(screen, c.GREEN if rxStatus[6] else c.RED, self.ch6_status)
        pygame.draw.rect(screen, c.GREEN if rxStatus[7] else c.RED, self.ch7_status)
